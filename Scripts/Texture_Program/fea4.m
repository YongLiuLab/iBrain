...
img_list = textread('/data/kzhao/Neuroimage_T1/MCAD/Reg/AD_S05.txt','%s');
lab_list = [];
for i = 1:length(img_list)
    lab_list = [lab_list;{['/data/kzhao/kzhao/Subtype_AS/Re_1203/Code/Code/temp/temp5.nii']}];
end
for i = 1:246
    ...
    nn = atlas_img;
    nn.img=z1;
    save_nii(nn,'/data/kzhao/kzhao/Subtype_AS/Re_1203/Code/Code/temp/temp5.nii');
    out_dir = ['/data/kzhao/NAT_Test/ibrain/MCADI/AD_S05'];
